export function validerKontonummer(kontonummer?: string): boolean {
  return validerLengdeOgTallPaKontonummer(kontonummer) && erGyldigNorskKontonummer(kontonummer)
}
...
function validerLengdeOgTallPaKontonummer(kontonummer?: string): boolean {
  if (!kontonummer) {
    return false
  }
...
function erGyldigNorskKontonummer(kontonummer?: string): boolean {
  if (!kontonummer) {
    return false
  }
