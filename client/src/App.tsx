    ...
    >
      ...
      <Routes>
        <Route
          path="/"
          element={
            <SettTittel title="helmet.title.virksomheter">
              <Virksomheter />
            </SettTittel>
          }
        />
        <Route
          path="/opprett-avtale/kvittering"
          element={
            <SettTittel title="helmet.title.avtale_kvittering">
              <AvtaleKvittering />
            </SettTittel>
          }
        />
        <Route
          path="/godta-bruksvilkarkvittering"
          element={
            <SettTittel title="helmet.title.avtale_kvittering">
              <BruksvilkårKvittering />
            </SettTittel>
          }
        />
        <Route
          path="/opprett-avtale/:orgnr"
          element={
            <SettTittel title="helmet.title.opprett_avtale">
              <OpprettAvtale />
            </SettTittel>
          }
        />
        <Route
          path="/godta-bruksvilkar/:orgnr"
          element={
            <SettTittel title="helmet.title.opprett_avtale">
              <GodtaBruksvilkår />
            </SettTittel>
        ...
        />
        <Route
          path="/oppdater-avtale/:orgnr"
          element={
            <SettTittel title="helmet.title.oppdater_avtale">
              <OppdaterAvtale />
            </SettTittel>
          }
        />
